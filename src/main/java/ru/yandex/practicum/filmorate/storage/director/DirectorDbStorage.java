...
public class DirectorDbStorage implements DirectorStorage {
    ...
    public Director create(Director director) {
        ...
        namedParameterJdbcTemplate.update(DirectorQuery.INSERT.getSql(),
                param,
                keyHolder,
                new String[]{"id"});
    ...
    public Optional<Director> getById(int id) {
        try {
            return Optional.ofNullable(
                    namedParameterJdbcTemplate.queryForObject(DirectorQuery.SELECT_BY_ID.getSql(),
    ...
    public boolean deleteById(int id) {
        return namedParameterJdbcTemplate.update(DirectorQuery.DELETE_BY_ID.getSql(),
