...
public class FilmDbStorage implements FilmStorage {
    ...
    public boolean deleteById(int id) {
        return namedParameterJdbcTemplate.update(FilmQuery.DELETE_BY_ID.getSql(),
    ...
    public List<Film> findByDirectorSorted(int directorId, String sortBy) {
        ...
        return namedParameterJdbcTemplate.query(FilmQuery.SELECT_BY_DIRECTOR_SORTED.getSql().formatted(orderBy),
