...
class UserDbStorageTests {
    ...
    public void testCreateUser() {
        ...
        User retrievedUser = userStorage.findById(createdUser.getId()).orElseThrow();
        assertThat(retrievedUser).isEqualTo(createdUser);
    }

    @Test
    public void testUpdateUser() {
        User existingUser = userStorage.findById(2).orElseThrow();
        ...
        User updatedUser = userStorage.findById(2).orElseThrow();
    ...
    public void testDeleteUser() {
        ...
        Optional<User> deletedUser = userStorage.findById(3);
    ...
    public void testFindUserByIdNotFound() {
        Optional<User> userOptional = userStorage.findById(999);
